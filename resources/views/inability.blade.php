                ...
                <form id="inabilityForm" name="sentMessage" method="post" action="{{ route('messages') }}" role="form">
                    ...
                    <div class="row align-items-stretch mb-5">
                        <div class="col-md-6">
                          ...
                          <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".6s">
                            <input type="text" placeholder="Document Type" class="form-control" name="document_type" id="document_type"
                                required="required" data-validation-required-message="Ingrese el tipo de documento." />
                        </div>
                        <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".6s">
                          <input type="text" placeholder="# Document" class="form-control" name="document" id="document"
