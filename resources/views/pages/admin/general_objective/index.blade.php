...
@section('content')
    ...
    <a href="{{ route('general_objective.create') }}" class="btn btn-primary btn-sm">Crear Nuevo</a>
    <div class="card-body">
        <div class="table-sm table-responsive">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                @foreach($general_objectives as $general_objective)
                    <tr class="active">
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $general_objective->description }}</td>
                        <td name="buttons">
                            <div class=" pull-right">
                                <a  href="{{ route('general_objective.edit', $general_objective->id) }}" id="bEdit" type="button"
