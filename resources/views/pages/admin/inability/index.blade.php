                            ...
                            <tbody>
                                @foreach ($inability as $inability)
                                    <tr class="active">
                                        ...
                                        <td>{{ $inability->date_end }}</td>
                                        <td><a target="_blank"
                                                href="storage/{{ str_replace('public/', '', $inability->pdf) }}">Descargar</a>
                                        </td>
                                        @role('Administrador')
                                        <td name="buttons">
                                            <div class=" pull-right">
                                                <a href="{{ route('inability.edit', $inability->id) }}" id="bEdit1"
                                                ...
                                                <button id="bAcep1" type="button"
                                                    class="btn btn-sm btn-soft-purple mr-2 btn-circle" style="display:none;"
                                                    onclick="rowAcep(this);"><i class="dripicons-checkmark"></i></button>
                                                <button id="bCanc1" type="button"
                                                    class="btn btn-sm btn-soft-info btn-circle" style="display:none;"
                                                    onclick="rowCancel(this);"><i class="dripicons-cross"
