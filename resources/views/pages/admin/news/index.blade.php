    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <div class="blog-card">
                        <img src="http://metrica.laravel.themesbrand.com/assets/images/small/img-9.jpg" alt="" class="img-fluid">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="meta-box">
                                <div class="media">
                                    <img src="http://metrica.laravel.themesbrand.com/assets/images/users/user-1.png" alt="" class="thumb-sm rounded-circle mr-2">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <div class="blog-card">
                        <img src="http://metrica.laravel.themesbrand.com/assets/images/small/img-10.jpg" alt="" class="img-fluid">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="meta-box">
                                <div class="media">
                                    <img src="http://metrica.laravel.themesbrand.com/assets/images/users/user-4.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                    <div class="media-body align-self-center text-truncate">
        ...
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body">
                    <div class="blog-card">
                        <img src="http://metrica.laravel.themesbrand.com/assets/images/small/img-11.jpg" alt="" class="img-fluid">
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="meta-box">
                                <div class="media">
                                    <img src="http://metrica.laravel.themesbrand.com/assets/images/users/user-3.jpg" alt="" class="thumb-sm rounded-circle mr-2">
                                    <div class="media-body align-self-center text-truncate">
