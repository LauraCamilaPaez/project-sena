...
@section('content1')
    ...
    <a href="{{ route('specific_objective.create') }}" class="btn btn-primary btn-sm">Crear Nuevo</a>
    <div class="card-body">
        <div class="table-sm table-responsive">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                @foreach($specific_objectives as $specific_objective)
                    <tr class="active">
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $specific_objective->description }}</td>
                        <td name="buttons">
                            <div class=" pull-right">
                                <a  href="{{ route('specific_objective.edit', $specific_objective->id) }}" id="bEdit" type="button"
