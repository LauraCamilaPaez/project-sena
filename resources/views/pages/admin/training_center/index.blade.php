...
@section('content')
    ...
    <a class="btn btn-primary btn-sm" href="">Crear Nuevo</a>
    <div class="card-body">
                    ...
                    <tr class="active">
                        ...
                        <td name="buttons">
                            <div class=" pull-right">
                                <a  action="{{ route('training_center.edit', $training_center->id) }}" id="bEdit" type="button"
                                ...
                                <form action="{{ route('training_center.destroy', $training_center->id) }}" action="" method="POST" style="display: inline">
                                    @csrf
                                    @method('DELETE')
